...
{  
  ...
  plot5a = ggplot(data=abundanceData[apr_to_sept,])+
    ...
    labs(title = "Plot 5a",
         subtitle = "Zooplankton vs. Larval white sucker abundance", # {closest_state} will refer to the varying state
         x = "Month",
  ...
  # If on a Mac these files won"t be read with your default viewer
